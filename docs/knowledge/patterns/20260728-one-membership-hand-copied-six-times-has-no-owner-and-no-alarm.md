...
bee:
  ...
  lifecycle: active
  sources: ["validation-diet cell vd-1 (GATED_PHASES + PHASE_GATE retarget, trace .bee/cells/vd-1.json, commit 4a03006e, 2026-07-28)", "validation-diet cell vd-2 (fall-through tail narrowed to !isKnownPhase, commit a7fab75d)", "validation-diet cell vd-4 (real-state-machine conformance test, commit 71729351)", "packages/bee/lib/guards.mjs:142,151", "packages/bee/lib/compaction.mjs:81", "packages/bee/lib/scratch.mjs:62", "packages/bee/lib/inject.mjs:235", "packages/bee/lib/intent.mjs:49", "packages/bee/lib/recovery.mjs:40", docs/history/validation-diet/CONTEXT.md D3/D4/D13]
  polarity: pitfall
  critical: true
---
