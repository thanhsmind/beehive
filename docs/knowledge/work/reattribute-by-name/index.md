...
# work/reattribute-by-name/

## Concepts

- [reattribute-by-name — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item reattribute-by-name: 1 capped cell(s), 1 recorded deviation(s).
