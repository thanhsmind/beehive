...
# work/knowledge-orphan-check/

## Concepts

- [knowledge-orphan-check — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item knowledge-orphan-check: 1 capped cell(s), 1 recorded deviation(s).
