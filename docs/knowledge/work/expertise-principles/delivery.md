...
bee:
  ...
  sources: [docs/history/expertise-principles/CONTEXT.md, docs/history/expertise-principles/plan.md, .bee/cells/archive/expertise-principles/ep-1.json, .bee/cells/archive/expertise-principles/ep-2.json, .bee/cells/archive/expertise-principles/ep-3.json, .bee/cells/archive/expertise-principles/ep-4.json, .bee/cells/archive/expertise-principles/ep-5.json, .bee/cells/archive/expertise-principles/ep-6.json, .bee/cells/archive/expertise-principles/ep-7.json, .bee/cells/archive/expertise-principles/ep-8.json, .bee/cells/archive/expertise-principles/ep-9.json]
---
