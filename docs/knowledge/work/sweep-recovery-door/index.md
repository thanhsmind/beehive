...
# work/sweep-recovery-door/

## Concepts

- [sweep-recovery-door — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item sweep-recovery-door: 3 capped cell(s), 0 recorded deviation(s).
