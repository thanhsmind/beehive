...
# work/windows-test-portability/

## Concepts

- [windows-test-portability — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item windows-test-portability: 2 capped cell(s), 3 recorded deviation(s).
