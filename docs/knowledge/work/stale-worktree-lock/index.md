...
# work/stale-worktree-lock/

## Concepts

- [stale-worktree-lock — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item stale-worktree-lock: 1 capped cell(s), 1 recorded deviation(s).
