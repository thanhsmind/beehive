...
# work/release-red-fixes/

## Concepts

- [release-red-fixes — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item release-red-fixes: 1 capped cell(s), 3 recorded deviation(s).
