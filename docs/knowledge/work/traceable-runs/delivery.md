...
bee:
  ...
  sources: [docs/history/traceable-runs/CONTEXT.md, docs/history/traceable-runs/plan.md, .bee/cells/archive/traceable-runs/trun-1.json, .bee/cells/archive/traceable-runs/trun-2.json, .bee/cells/archive/traceable-runs/trun-3.json, .bee/cells/archive/traceable-runs/trun-4.json, .bee/cells/archive/traceable-runs/trun-5.json, .bee/cells/archive/traceable-runs/trun-6.json, .bee/cells/archive/traceable-runs/trun-7.json, .bee/cells/archive/traceable-runs/trun-8.json, .bee/cells/archive/traceable-runs/trun-9.json]
---
...
Proposed by `bee knowledge promote --work traceable-runs` from 9 capped cell trace(s) in `.bee/cells/` and the anchor `docs/history/traceable-runs/CONTEXT.md`, `docs/history/traceable-runs/plan.md`. Applied 2026-08-16 from docs/history/traceable-runs/promote-proposals.md; area bullets declined (feature-wide scribing sync already recorded 2026-08-14), pattern candidates triaged separately.
