...
# work/herding-agent-brief/

## Concepts

- [herding-agent-brief — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item herding-agent-brief: 2 capped cell(s), 2 recorded deviation(s).
