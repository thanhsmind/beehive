...
# work/class-playbooks/

## Concepts

- [class-playbooks — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item class-playbooks: 1 capped cell(s), 1 recorded deviation(s).
