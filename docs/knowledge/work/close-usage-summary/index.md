...
# work/close-usage-summary/

## Concepts

- [close-usage-summary — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item close-usage-summary: 1 capped cell(s), 1 recorded deviation(s).
