...
bee:
  ...
  sources: [docs/history/slp-supervisor-heartbeat/CONTEXT.md, docs/history/slp-supervisor-heartbeat/plan.md, .bee/cells/archive/slp-supervisor-heartbeat/sup-1.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-2.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-3.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-5.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-6.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-7.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-8.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-9.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-10.json, .bee/cells/archive/slp-supervisor-heartbeat/sup-11.json]
---
...
- **sup-10** — blocked-rate takes its denominator as the union of cells claimed in the window and cells blocked in it, not literally claimed cells: a real swept-blocked cell (.bee/cells/archive/merge-door-precision/mdp-1.json) has claimed_at null, so blocked-over-claimed can exceed 1 and is not derivable — the plan was wrong about a fact
