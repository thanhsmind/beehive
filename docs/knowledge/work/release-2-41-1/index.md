...
- [release-2-41-1 — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item release-2-41-1: 1 capped cell(s), 1 recorded deviation(s).
