...
# work/herding-activity-hook/

## Concepts

- [herding-activity-hook — delivery](delivery.md) — Delivery record for work item herding-activity-hook: 2 capped cell(s), one contract-changing deviation, and the verify each cell capped against.
