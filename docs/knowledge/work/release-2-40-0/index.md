...
- [release-2-40-0 — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item release-2-40-0: 1 capped cell(s), 2 recorded deviation(s).
