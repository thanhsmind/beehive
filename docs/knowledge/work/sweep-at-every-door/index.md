...
# work/sweep-at-every-door/

## Concepts

- [sweep-at-every-door — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item sweep-at-every-door: 2 capped cell(s), 0 recorded deviation(s).
