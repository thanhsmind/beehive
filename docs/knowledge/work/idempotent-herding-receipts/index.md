...
# work/idempotent-herding-receipts/

## Concepts

- [idempotent-herding-receipts — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item idempotent-herding-receipts: 2 capped cell(s), 3 recorded deviation(s).
