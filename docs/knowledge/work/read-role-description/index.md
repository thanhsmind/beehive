...
# work/read-role-description/

## Concepts

- [read-role-description — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item read-role-description: 1 capped cell(s), 1 recorded deviation(s).
