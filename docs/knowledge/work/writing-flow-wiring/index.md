...
# work/writing-flow-wiring/

## Concepts

- [writing-flow-wiring — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item writing-flow-wiring: 2 capped cell(s), 5 recorded deviation(s).
