...
# work/leader-sees-team/

## Concepts

- [leader-sees-team — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item leader-sees-team: 3 capped cell(s), 6 recorded deviation(s).
