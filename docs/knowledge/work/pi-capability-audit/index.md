...
# work/pi-capability-audit/

## Concepts

- [pi-capability-audit — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item pi-capability-audit: 0 capped cell(s), 0 recorded deviation(s).
