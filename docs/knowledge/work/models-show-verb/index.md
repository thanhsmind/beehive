...
# work/models-show-verb/

## Concepts

- [models-show-verb — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item models-show-verb: 3 capped cell(s), 7 recorded deviation(s).
