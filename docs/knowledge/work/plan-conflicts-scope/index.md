...
# work/plan-conflicts-scope/

## Concepts

- [plan-conflicts-scope — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item plan-conflicts-scope: 2 capped cell(s), 5 recorded deviation(s).
