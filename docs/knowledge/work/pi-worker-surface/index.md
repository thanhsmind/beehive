...
# work/pi-worker-surface/

## Concepts

- [pi-worker-surface — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item pi-worker-surface: 2 capped cell(s), 2 recorded deviation(s).
