...
bee:
  ...
  sources: [docs/history/pi-support/CONTEXT.md, docs/history/pi-support/plan.md, .bee/cells/archive/pi-support/pis-1.json, .bee/cells/archive/pi-support/pis-2.json, .bee/cells/archive/pi-support/pis-3.json, .bee/cells/archive/pi-support/pis-4.json]
---
