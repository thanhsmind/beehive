...
# work/pi-full-workflow-parity/

## Concepts

- [pi-full-workflow-parity — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item pi-full-workflow-parity: 2 capped cell(s), 3 recorded deviation(s).
