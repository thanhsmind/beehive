...
# work/herding-preflight-test-seam/

## Concepts

- [herding-preflight-test-seam — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item herding-preflight-test-seam: 1 capped cell(s), 3 recorded deviation(s).
