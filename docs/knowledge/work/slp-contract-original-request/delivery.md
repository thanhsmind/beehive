...
bee:
  ...
  sources: [docs/history/slp-contract-original-request/CONTEXT.md, docs/history/slp-contract-original-request/plan.md, .bee/cells/archive/slp-contract-original-request/scor-1.json, .bee/cells/archive/slp-contract-original-request/scor-2.json, .bee/cells/archive/slp-contract-original-request/scor-3.json, .bee/cells/archive/slp-contract-original-request/scor-4.json, .bee/cells/archive/slp-contract-original-request/scor-5.json, .bee/cells/archive/slp-contract-original-request/scor-6.json]
---
