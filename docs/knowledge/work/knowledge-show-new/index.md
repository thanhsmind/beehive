...
# work/knowledge-show-new/

## Concepts

- [knowledge-show-new — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item knowledge-show-new: 1 capped cell(s), 0 recorded deviation(s).
