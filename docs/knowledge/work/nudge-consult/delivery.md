...
bee:
  ...
  sources: [docs/history/nudge-consult/CONTEXT.md, .bee/cells/archive/nudge-consult/nc-1.json, .bee/cells/archive/nudge-consult/nc-2.json, .bee/cells/archive/nudge-consult/nc-3.json]
---
