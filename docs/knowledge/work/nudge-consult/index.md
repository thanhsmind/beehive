...
- [nudge-consult — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item nudge-consult: 3 capped cell(s), 3 recorded deviation(s).
