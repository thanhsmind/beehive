...
- [awaiting-human — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item awaiting-human: 4 capped cell(s), 1 recorded deviation(s).
