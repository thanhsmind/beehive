...
# work/uat-close-instruction-parity/

## Concepts

- [uat-close-instruction-parity — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item uat-close-instruction-parity: 1 capped cell(s), 3 recorded deviation(s).
