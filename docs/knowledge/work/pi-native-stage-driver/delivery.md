...
bee:
  ...
  sources: [docs/history/pi-native-stage-driver/CONTEXT.md, docs/history/pi-native-stage-driver/plan.md, .bee/cells/archive/pi-native-stage-driver/pnsd-1.json, .bee/cells/archive/pi-native-stage-driver/pnsd-2.json, .bee/cells/archive/pi-native-stage-driver/pnsd-3.json, .bee/cells/archive/pi-native-stage-driver/pnsd-4.json, .bee/cells/archive/pi-native-stage-driver/pnsd-5.json, .bee/cells/archive/pi-native-stage-driver/pnsd-6.json, .bee/cells/archive/pi-native-stage-driver/pnsd-7.json]
---
