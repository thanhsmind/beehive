...
- [three-findings — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item three-findings: 3 capped cell(s), 3 recorded deviation(s).
