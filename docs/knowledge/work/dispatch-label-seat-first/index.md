...
# work/dispatch-label-seat-first/

## Concepts

- [dispatch-label-seat-first — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item dispatch-label-seat-first: 1 capped cell(s), 1 recorded deviation(s).
