...
# work/install-fetch-reason/

## Concepts

- [install-fetch-reason — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item install-fetch-reason: 1 capped cell(s), 2 recorded deviation(s).
