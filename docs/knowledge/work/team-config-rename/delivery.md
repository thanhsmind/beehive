...
bee:
  ...
  sources: [docs/history/team-config-rename/CONTEXT.md, docs/history/team-config-rename/plan.md, .bee/cells/archive/team-config-rename/tcr-1.json, .bee/cells/archive/team-config-rename/tcr-2.json, .bee/cells/archive/team-config-rename/tcr-3.json, .bee/cells/archive/team-config-rename/tcr-4.json]
---
