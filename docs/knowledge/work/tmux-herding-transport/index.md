...
# work/tmux-herding-transport/

## Concepts

- [tmux-herding-transport — delivery](delivery.md) — Delivery record for work item tmux-herding-transport: 6 capped cell(s), the contract-changing deviations, and the verify each cell capped against.
