...
# work/mise-shim-stdout/

## Concepts

- [mise-shim-stdout — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item mise-shim-stdout: 1 capped cell(s), 1 recorded deviation(s).
