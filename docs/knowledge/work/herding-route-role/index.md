...
# work/herding-route-role/

## Concepts

- [herding-route-role — delivery](delivery.md) — Delivery record proposed by bee knowledge promote for work item herding-route-role: 7 capped cell(s), 15 recorded deviation(s).
