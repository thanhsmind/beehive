...
- [Doctrine Layer — the communication contract](the-communication-contract.md) — The single ruleset for what execution reports to the person being served, and in what shape: five reader facts, the open/body/close turn shape, seven standing rules, when the rules deliberately break, and the pre-send acceptance test.
