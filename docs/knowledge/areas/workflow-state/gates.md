...
- Native terminal-state door (R21a, both escapes): the compounding-complete
  ...
  trace `.bee/cells/archive/terminal-phase-port/tpp-1.json`, commit `7f0381a5`; discovery decision
...
- Soft promote door (R80, knowledge-loop D2/D9): `build_promotion` called
  ...
  `.bee/cells/archive/knowledge-loop/kl-3.json`, commit `384587a1`; trace `.bee/cells/archive/knowledge-loop/kl-5.json`,
  commit `c8d25dff`.
...
- Approvals-map shape coercion (B53/R104): `spread_gates` in
  ...
  old error branch. Evidence: trace `.bee/cells/archive/js-parity-cleanup/jp-4.json` (999 passed, 0 failed,
