...
bee:
  ...
  sources: ["counter-teeth cell ct-3 (trace .bee/cells/ct-3.json, 2026-08-04 — escalation reuses the existing pending membership; status_full 49 passed, 0 failed)", docs/history/counter-teeth/CONTEXT.md, "packages/bee-rs/crates/bee/src/verbs/status_full/orient.rs:134-181 (the two constants and the escalation predicate)", "packages/bee-rs/crates/bee/src/verbs/status_full/records.rs:215 (pending membership — stub rows minus flush rows)"]
