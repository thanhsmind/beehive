...
Publish 2.43.0 from `main`. One command does the whole release; this plan exists
...
```json
{
  ...
  "stages": [
    {"stage":"deployment","classification":"required","role":"deploy","reason":"This lane exists to publish 2.43.0; the deploy role owns the release permit."},
