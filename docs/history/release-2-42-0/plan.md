...
Publish 2.42.0 from `main`. One command does the whole release; this plan exists
...
| 5 | The version moves from the released 2.41.3 | ran | `.claude-plugin/plugin.json` | `"version": "2.41.3"` |
| 6 | The work this release ships is capped, judged and proven | ran | `docs/history/leader-check-door/plan.md`, cells lcd-1..lcd-4 | full suite 4178 passed, 0 failed; each cell carries an ok leader check |
...
```json
{
  ...
  "stages": [
    {"stage":"deployment","classification":"required","role":"deploy","reason":"This lane exists to publish 2.42.0; the deploy role owns the release permit."},
