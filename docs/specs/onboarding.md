...
| P2 | [docs/knowledge/areas/onboarding/installer-entrypoints-and-source-staging.md](../knowledge/areas/onboarding/installer-entrypoints-and-source-staging.md) | the complete onboarding suite — `skills/bee-hive/scripts/tests/test_onboard_bee.mjs` |
