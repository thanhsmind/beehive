...
| P5 | [docs/knowledge/areas/verify-pipeline/concurrency-and-hermetic-runs.md](../knowledge/areas/verify-pipeline/concurrency-and-hermetic-runs.md) | `bee dev render-skill-trees`, `scripts/tests/test_render_race.mjs` — locked tmp-swap render + race proof |
