...
- **References:** `planning-reference.md` (artifact templates, cell quality rules, epic-map vs phase-plan guidance), `edge-dimensions.md` (the 12 edge-case dimensions for the test matrix), `playbooks/<class>.md` (one file per route class, per the "Playbooks" pointer).
