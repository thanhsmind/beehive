...
- [ ] `metadata.version: '0.1'`, `metadata.ecosystem: bee`, `metadata.dependencies` mapping or `[]` (never a YAML array of objects — `writing-skills-references/checklist-examples.md` ("Dependency metadata style"))
...
- [ ] Short `Headless` section; Red Flags list; persuasion principles applied (`writing-skills-references/checklist-examples.md` ("Persuasion principles")); HARD-GATE markers on critical stops
