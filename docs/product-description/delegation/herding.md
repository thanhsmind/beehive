...
- Part of this document's vocabulary is now in the [glossary](../glossary.md) (*cockpit*, *control loop*, *enable marker*, *stop marker*, *working agent*); still absent: *control pane*, *transport*, *pane verb*, *wave ledger*, *occupancy*. They are used here as defined in-line and are proposed for the glossary rather than coined as synonyms for existing terms.
