...
- **Handoff:** Gate 4 → `standard`/`high-risk`: "Invoke bee-shaping (Brief walkthrough)," which then hands to the Scribe sync; `tiny`/`spike`/`small`: "Invoke bee-capturing (Scribe)."
