...
// leading whitespace is content.
    ...
    use crate::verbs::knowledge::{resolve_anchor, Anchor, ConceptLike};
...
// ─── concept inventory (collectConcepts) ───────────────────────────────────
    ...
    // The shared anchor.rs fallback resolver (D1/D5/D6/D8) is generic over
    // anything with a bundle-relative path and parsed frontmatter data — this
    // is this port's own two-line supply of that shape, kept independent of
    // knowledge::walk::Concept exactly like every other duplicated helper in
    // this file.
