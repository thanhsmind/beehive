...
| `claim`/`cap` refuse unexpectedly                                                  | Working as designed: check`bee status` for gate states — execution must be approved (Gate 2), cells must have a passing recorded verify before capping                                                                                                                                         |
