...
| `docs/knowledge/areas/doctrine-layer/router-triage-and-the-agents-md-duplication-boundary.md` ("Principle homes") | The routed principles for this class, and what each one's spoken line is |
